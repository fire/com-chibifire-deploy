...
helm install gocd stable/gocd --namespace gocd --set agent.replicaCount=3 --set agent.image.repository="ifire/gocd-agent-fedora-30" --set agent.image.tag=v19.9.0-chibifire-0.3 --set agent.security.ssh.enabled=true --set server.security.ssh.enabled=true --kubeconfig /etc/rancher/k3s/k3s.yaml
